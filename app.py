...
def load_data(uploaded_file):
    ...
    for idx, row in df_preview.iterrows():
        # Converte cada item da linha explicitamente para string
...
if uploaded_file is not None:
    try:
        ...
        # Limpeza de Textos (Garantindo conversão elemento a elemento para evitar erros de tipo)
        ...
        # Filtra linhas de sujeira/cabeçalhos extras
        erros_invalidos = ['CHAMADO', 'STATUS', 'INVENTÁRIOS', 'INVENTARIOS', 'TOTAL']
