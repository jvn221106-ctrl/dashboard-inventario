...
def renderizar_tela_login():
    ...
    with st.expander("❓ Esqueceu a senha?"):
        st.info("📩 **Entre em contato com o Administrador** para solicitar uma senha temporária.\n\nAo logar com a senha temporária, o sistema exigirá que você cadastre uma nova senha pessoal.")
