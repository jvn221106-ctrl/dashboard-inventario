...
# ttl=60 garante que o Streamlit recarregue os dados da nuvem a cada 60 segundos
@st.cache_data(ttl=60)
def load_data(url):
    # Lê os dados publicados diretamente do Google Sheets
    df = pd.read_csv(url)
    ...
    # Tratamento numérico (substitui vírgula por ponto se necessário)
...
try:
    ...
    # Botão para forçar atualização manual dos dados
