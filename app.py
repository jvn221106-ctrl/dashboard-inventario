...
NOME_ARQUIVO = "STATUS DOS INVENTÁRIOS"  # Altere para o nome exato do seu arquivo na pasta
...
if os.path.exists(NOME_ARQUIVO):
    try:
        ...
        st.error(f"Erro ao processar a planilha salva: {e}")
else:
